...
class Kermaka:
    def __init__(self, step, tau_1, tau_2, func_1="", func_2="", func_3=""): # formula is optional
        self.step = step
        self.tau_1 = tau_1
        self.tau_2 = tau_2
        self.func_1 = func_1
    ...
    def calculate(self):
        T=40
        t = np.arange(0, T + 2*self.step, self.step)
        x = np.zeros(t.size)
        y = np.zeros(t.size)
        z = np.zeros(t.size)
        v = np.zeros(t.size)
    ...
    def S(self, t, s, i_, r, s_zap_1, s_zap_2, i_zap_1, i_zap_2, r_zap_1, r_zap_2):
        return -s*i_zap_1+i_zap_2

    def I(self, t, s, i_, r, s_zap_1, s_zap_2, i_zap_1, i_zap_2, r_zap_1, r_zap_2):
        return s*i_zap_1 - i_

    def R(self, t, s, i_, r, s_zap_1, s_zap_2, i_zap_1, i_zap_2, r_zap_1, r_zap_2):
        return i_-i_zap_2
